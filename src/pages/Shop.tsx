      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
        ...
        <aside className="space-y-8 lg:col-span-1">
          ...
          <div className="bento-card p-8 bg-brand-gold text-black relative overflow-hidden group shadow-lg shadow-brand-gold/15">
             <div className="absolute -right-16 -bottom-16 w-36 h-36 bg-black/10 rounded-full blur-2xl group-hover:scale-110 transition-all duration-500 ease-out duration-500 ease-out" />
             ...
             <Link 
               to="/contact" 
               className="w-full py-3.5 bg-black text-white rounded-xl text-[9px] font-black uppercase tracking-hero text-center block hover:scale-[1.02] active:scale-95 transition-all duration-500 ease-out duration-500 ease-out"
             >
               {t('shop.bespoke.cta')}
             </Link>
          </div>
                ...
                {viewType === 'grid' ? (
                    ...
                    <div className="relative aspect-[4/5] overflow-hidden rounded-t-[1.8rem]">
                      ...
                      <div className="absolute top-4 right-4 flex flex-col gap-2 z-20">
                        ...
                        <button 
                          ...
                          className="p-2.5 glass text-foreground rounded-full shadow-md hover:scale-110 transition-all duration-500 ease-out duration-500 ease-out"
                        >
                  ...
                  <div className="bento-card glow-tracer p-6 flex flex-col md:flex-row items-center gap-8 group w-full">
                    <div className="w-48 h-48 rounded-2xl overflow-hidden shrink-0 relative mx-auto md:mx-0">
                      <img src={product.image} alt={t('product.' + product.id + '.name')} className="w-full h-full object-cover group-hover:scale-105 transition-all duration-700 ease-out" />
                    ...
                    <div className="shrink-0 text-center md:text-right flex flex-col justify-center gap-3 min-w-[150px]">
                      ...
                      <button 
                        onClick={() => handleAddToCart(product)}
                        className="w-full py-3 bg-brand-gold text-black rounded-xl text-[9px] font-black uppercase tracking-widest hover:scale-102 transition-all duration-500 ease-out shadow shadow-brand-gold/15"
                      >
                        {t('nav.cart')}
                      </button>
                      <button 
