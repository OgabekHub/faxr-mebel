          ...
          >
            <div className="flex justify-between items-center pb-4 border-b border-foreground/5">
              ...
              <button 
                ...
                className="bg-brand-gold text-black px-5 py-3 rounded-xl font-extrabold text-[9px] uppercase tracking-hero flex items-center gap-1.5 hover:scale-103 transition-all duration-500 ease-out duration-500 ease-out"
              >
